...
public sealed class Book : Entity
{
    ...
    // Writer
    [Required] public Guid WriterId { get; set; }

    [ForeignKey(nameof(WriterId))] public Writer Writer { get; set; } = default!;
    ...
    [ForeignKey(nameof(PublisherId))] public Publisher Publisher { get; set; } = default!;
}