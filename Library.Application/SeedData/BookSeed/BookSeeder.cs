...
{ 
    ...
    // DB'den gerekli listeler
        ...
        var languages = new[] { "English", "Türkçe", "Deutsch", "Français", "Español", "Italiano", "Русский", "العربية", "日本語" };
        ...
        var bookFaker = new Faker<Book>("tr")
            ...
            .RuleFor(b => b.PageCount, f => f.Random.Bool(0.8f) ? f.Random.Int(80, 900) : (int?)null)
            .RuleFor(b => b.PublishedDate, f =>
            {
                if (!f.Random.Bool(0.75f)) return (DateTimeOffset?)null;
